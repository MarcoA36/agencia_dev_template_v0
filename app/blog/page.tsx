...
export default function BlogPage() {
  const posts = [
    ...
    },
    {
      ...
      excerpt:
        "Exploramos las tecnologías y metodologías que están transformando el desarrollo web este año.",
    ...
    },
    {
      ...
      excerpt:
        "Por qué invertir en experiencia de usuario es fundamental para el éxito de tu proyecto digital.",
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <HeroSection
          title="Blog"
          subtitle="Conocimiento, tendencias y mejores prácticas en desarrollo web"
        />
